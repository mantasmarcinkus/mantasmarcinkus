...
### Salaries
As this is more or less the most interesting part of this blog post, I\`ll leave it here in the beginning. After reading a lot of articles and GlassDoors position reviews, the positions and the salaries looked to be distributed like this:  
...
I want to highlight the fact, that the edge cases of these salaries are not beign offered, e.g. Mid level developer is offered £40k-£45k, because in the upcoming few years the developers salary will get raised but without changing his title. Also, the salary offered depends on the companies budget, as there are companies looking for a senior developer, but don\`t have the budget to offer a competetive salary, nor they have an interesting project to offer.  
### Recruiters vs Companies
When I arrived to the city I had two clear choices: to go to recruiters (who offer they services free of charge for those looking for a job) or to look for job ads by yourself and go straight to the companies. Both of these have pros and cons.
#### Recruiters
**\+** Recruiters are specialised, so when you contact recruiter firm, they will instantly offer you atleast 15 offers for a position you are looking for.
...
**\+** Recruiters get their money from companies who hire an employee and they stay for a period of time in the company (3-6months/probation period). Their earnings range from 20% of junior developer\`s yearly salary of contract that was signed to 50% or more when the senior developer is signed with unique expertise.
...
**+-** Recruiters have their CV template, so the posibility to stand out with the CV is negated and the only things that matters is your experience.
...
#### Companies
**\+** The search is of a job is very selective as you are looking for a company where your particular set of skills is being looked for.
...
2. (May happen) You will have to develop an application in a period of 2-3 hours solving a small problem using your best effort. For example:
  - Console application, where an in-game player will be ordered to move on the board. The player is penalized for leaving the board. There are test data provided with the outputs. What is expected? Sepeartion of concerns, interfaces, basic logic, unit tests.
  - Event web page with integration to a persistence layer (database). With the possibility to create and register to an event, and it could be done in different time zones, and with the support of [Cyrillic](https://en.wikipedia.org/wiki/Cyrillic_script). What is expected? Seperation of concerns, EF code first, Unit tests, Locale handling, basic validation, proper API (REST) interfaces.
2. (May happen). Technical interview using an [online platform](https://coderpad.io/)
3. Face to face interview:
  - (May happen) An interview with HR personnel, where you have to explain what your goals are and to measure your motivation and how would you look like in a team. Often, HR can see through a person after several minutes, so you have to be sincere. Also, you are being tested if you match the companies culture - how well you will fit in the company. 
  - The technical interview is definetely happening, however it varies wildly. It could last from 30 minutes to an hour and a half. Often, during this part of interview you will go through your CV explaining what\`s written there about the skills you said you have. During the technical part, you can be asked anything from basic knowledge of the language you develop to explaing how some specific framework flow works. There are questions that are very specific, which hardly provide any information about the knowledge or the skills the person has, but this is completely different topic. More often that not, you will have a whiteboard discussion, which is currently wildly discussed, and has it\`s own pros and cons ([most important](https://github.com/poteto/hiring-without-whiteboards), [here](https://medium.com/make-better-software/against-the-whiteboard-f1df0013954f), [here](https://theoutline.com/post/1166/programmers-are-confessing-their-coding-sins-to-protest-a-broken-job-interview-process)). If you had done a prior programming task before this interview part, you may be asked to describe why you made some decisions and maybe extend or edit the code you developed.
...
4. (Might happen) After the offer is propsed, it is possible, that companies will try to reach out to you (through a recruiter or directly) and will ask how much time do you need to answer to the offer and might offer to speak with someone you had interview with to try to convince you to join. I would want to warn that these awkward conversations can be easily avoided, because they hardly provide any new information and wastes both party\`s time. To answer the question when you are going to provide an answer for the offer don\`t hesitate to say that it will be soon, without providing a concrete date, which may force you to hurry picking.

After every stage of interviews companies will catchup to say what the decision they\`ve made, to continue or to end there. If all the stages have been passed successfuly, it is possible, you will get an offer, maybe even several offers. The decision is of course for the person to make. But my personal priorites that I have set was: 
...
First and the most important thing is to get familiar with the news of the technology you are interviewing with and check all the basics of that technology. This is really important, because some of the questions asked are not really used in real life developement (like sealed classes, or optimising addition). If going for an interview with a bigger company like Amazon, Microsoft, Google oftenly you will be expected to have a really good understanding of algorithms. There is a good count of applications to refresh your knowledge about [algorithms and data structures](https://play.google.com/store/apps/details?id=com.marcyliao.app.algnote). These basics are useful not only in the interviews, but rather more useful in real life (however, if you haven\`t understood that yet, you will. Eventually.).  
It is said and there is a lot written, that you have to get to know the company you are interviewing with. However, my experience shows, that oftenly the information provided on the companies is vague or the company does way too much things (Amazon, Google). Also, the time that takes you to find information on the second Google search page is not worth it.  
How to prepare yourself mentally? It\`s trivial: 
- Be sincere (I know it is much harder to do than it is said, but relaxing is the key. I\`ve though about writing \`Be yourself\`, but nobody wants you to be \`yourself\`. You have to be adaptable. [good read](https://www.nytimes.com/2016/06/05/opinion/sunday/unless-youre-oprah-be-yourself-is-terrible-advice.html))
- Don\`t be scared of talking
- Tell as much as you can about yourself and the problems you had in your carrer and how you solved them
- Discuss about everything and ask honest questions (not everything everything, but kinda everything)
...
### Ask questions!
It is important, that in the end of the interview you ask questions when you are allowed to do so. Naturally, after an hour or more of intensive problem solving session you would want to leave ASAP, buy a ciggarette package and go for a smoke (even if you don\`t smoke). That\`s why you have to prepare your questions beforehand and thourougly think them through. These questions have to be written down, because a person hardly can remember anything after this kind of marathon. My personal list of questions I ask is this:  
- Can you explain your Business model in a sentence or two?
- What is your personal goal? (More less like \`I want more moeny\`, more like \`I want to solve our clients problems using X,Y,Z technologies\`)
...
Some of these questions will be answered during the interview, so be aware that if you don\`t have questions go ahead and say that you came prepared, but they did a good job by clearing everything out. Obviously, you could still have some questions that arose during the interview that are not on the list you prepared and you sure have to ask them (It is for the tranquility of you mind!). 
### Summary
Even though, software develoeprs being very demanded and it seems that the developer is selecting the company he is going to work for, not the company is selecting the employee, but it is a myth. More often than not, the mindset of company and employee have to match to reach a mutual goal. So when you are looking for a job, you have to show your desire, even before the interview. The demand surpasses the supply of the developers, however, oftenly developers feel like special gems, which they are not, and my advice would be to be open to yourself and look for a job you really qualify, rather than being an [imposter](https://blog.valbonne-consulting.com/2014/08/16/the-imposter-syndrome-in-software-development/). So if you are looking for a job - good luck and be sincere!

### Afterthoughts
I haven\`t written about these things in this scrabble, for the reason I did not have these things or considered them important, or will write upon these later:
